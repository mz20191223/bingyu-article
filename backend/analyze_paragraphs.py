...
with app.app_context():
    ...
    print("\n=== 用户期望 ===")
    print("  图片1: 开头之前")
    print("  图片2: 段落2之后（即'很多人搜优惠券哪里最好...'这段之后）")
    print("  图片3: 段落5之前（即'【优惠券好不好，关键看这3点】'这段之前）")

    print("\n=== 当前实际效果 ===")
    print("  图片1插入到了开头 ✓")
    print("  图片2插入到了段落2之后（'很多人搜...'之后）✓")
    print("  图片3插入到了段落5之前（'【优惠券好不好...】'之前）✓")

    print("\n=== 问题分析 ===")
    print("系统的段落计数包含了标题行！如果你希望：")
    print("  - 图片2在第二个【正文】段落之后")
    print("  - 图片3在第五个【正文】段落之前")
    print("请告诉我，我可以修改逻辑只计算正文段落，或者你调整段落号配置。")
